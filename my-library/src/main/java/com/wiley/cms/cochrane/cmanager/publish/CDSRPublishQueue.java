...
@MessageDriven(
        activationConfig = {
            ...
            @ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/clsysrev_publishing"),
            @ActivationConfigProperty(propertyName = "maxSession", propertyValue = "1")
        }, name = "CDSRPublishQueue")
@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
public class CDSRPublishQueue extends WRPublishQueue implements MessageListener {
    static final String MAP_NAME = "java:jboss/exported/jms/queue/clsysrev_publishing";
